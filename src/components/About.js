...
export default function About() {
  return (
    <div
      id="about"
      className="container md:flex md:flex-row flex-col bg-[#f2f2f2] "
    >
      ...
      <div className="item md:w-1/2 w-full">
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="flex flex-col space-y-8 sm:flex-row sm:space-x-4">
            <div className="w-full ">
              ...
              <p className="text-gray-700 leading-loose">
                At ABC Real Estate, we are dedicated to revolutionizing the
                construction industry through innovation, transparency, and
                exceptional service. With years of experience and a passion for
                excellence, we strive to provide our clients with comprehensive
          ...
          <div>
            ...
            <p className="text-gray-700 leading-loose">
              Behind ABC Real Estate is a team of skilled professionals
              committed to excellence in every project we undertake. With
              expertise spanning construction management, finance, and
              technology, our team works tirelessly to ensure the success of
