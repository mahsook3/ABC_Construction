...
export default () => {
    return (
        <footer className="pt-10 bg-[#535353]">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="justify-between items-center gap-12 md:flex">
                    <div className="flex-1 max-w-lg">
                       <img src={logo} alt="logo" className="w-20 flex flex-center" />
                    </div>
                ...
                <div className="mt-16 space-y-6 justify-between sm:flex md:space-y-0">
                    <div className="hidden md:flex space-x-8">
                        <a href="#" className="text-white hover:text-gray-200 text-base font-medium">Service</a>
                        <a href="#" className="text-white hover:text-gray-200 text-base font-medium">Features</a>
                        <a href="#" className="text-white hover:text-gray-200 text-base font-medium">Contact</a>
                        <a href="#" className="text-white hover:text-gray-200 text-base font-medium">About</a>
                    </div>
                ...
                <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
                    <div className="hidden md:flex space-x-8">
                        <a href="#" className="text-white hover:text-gray-200 text-base font-medium">English</a>
                        <a href="#" className="text-white hover:text-gray-200 text-base font-medium">Privacy</a>
                        <a href="#" className="text-white hover:text-gray-200 text-base font-medium">Legal</a>
                    </div>
                    <div className="py-10 items-center justify-between sm:flex">
                        <p className="text-gray-300">© 2023 ABC Real Estate. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </footer>
