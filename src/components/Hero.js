  ...
  const [heroData, setHeroData] = useState([
    {
      ...
      description:
        "Real-time Updates, Seamless Monitoring, Complete Peace of Mind",
      buttons: [
        {
    ...
    },
    {
      ...
      description:
        "From Blueprint to Reality: Witness Every Phase of Construction",
      buttons: [
        {
          text: "Track Construction Progress",
          color: "white",
    ...
    },
    {
      ...
      description:
        "Transform Ideas into Reality: Your Construction Journey Starts Here",
      buttons: [
        {
          text: "Track Construction Progress",
          color: "white",
