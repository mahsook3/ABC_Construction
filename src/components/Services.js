      ...
      <div className="flex-1">
        <div className="container mx-auto flex flex-wrap justify-center gap-8">
          ...
          <div className="bg-yellow-500 text-center text-white p-4 rounded-lg w-72">
            <h2 className="text-3xl font-bold mb-2">Construction Management</h2>
            <p className="text-base">
              Our experienced construction management team oversees every aspect
              of your project, ensuring seamless coordination, timely execution,
